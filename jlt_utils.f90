...
!--------------------------------   public  ----------------------------------!
  ...
  public :: set_log_unit_id         ! subroutine (log_uid)
  public :: init_log                ! subroutine (my_name, log_dir)
  public :: finalize_log            ! subroutine ()
  public :: put_log                 ! subroutine (log_str, log_level)
  public :: open_log_file           ! subroutine ()
  public :: close_log_file          ! subroutine ()
  public :: error                   ! subroutine (routine_name, error_str)
  public :: check_argument          ! subroutine (routine_name, my_value, l_value, u_value)
  public :: IntToStr                ! character(len=STR_MID) function (int)
  public :: LongIntToStr            ! character(len=STR_MID) function (lint)
  public :: StrToInt                !
  public :: IDate2CDate             !
...
subroutine init_log(my_model_name, log_dir)
  ...
  if (get_log_level() /= NO_OUTPUT_LOG) then
    ...
    file_name = "jlt."//trim(model_name)//".coupling.log.PE"//pe_num
...
subroutine open_log_file(file_name, log_file_unit)
  implicit none
...
subroutine put_log_to_stderr(log_l, LogStr)
  use jlt_mpi_lib, only : jml_isLocalLeader
  implicit none
...
subroutine write_error_message(ErrorStr)
  use jlt_mpi_lib, only : jml_isRoot
  implicit none
  ...
  if (jml_isRoot()) then
    !call set_date_time_string()
    write(STD_ERR, *) errorStr ! write message
  end if
...
subroutine error(routine_name,message)
  use jlt_mpi_lib, only : jml_abort
  implicit none 
